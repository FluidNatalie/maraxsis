                    ...
                    action = {
                        ...
                        action_delivery = {
                            ...
                            target_effects = {
                                {
                                    type = "create-sticker",
                                    sticker = "maraxsis-hypno-sticker",
                                    show_in_tooltip = true,
                                },
                                {
                                    type = "create-sticker",
                                    sticker = "maraxsis-hypno-sticker-behind",
                                    show_in_tooltip = false,
                                },
                                {
                                    type = "script",
                                    effect_id = "maraxsis-hypno-sticker-applied",
                                },
                            },
                        },
                    },
...
local function extend_sticker_effects()
    ...
    data:extend {maraxsis.merge(data.raw.sticker["bioflux-speed-regen-sticker-behind"], {
        name = "maraxsis-hypno-sticker-behind",
        icon = "__maraxsis__/graphics/icons/hypno.png",
        icon_size = 64,
